...
## Contents
[The Python Cryptor](#the-python-cryptor)
[Configurable Payload](#configurable-payload)
[Configurable Encryption Key](#configurable-encryption-key)
[Testing Python Cryptor Program](#Testing-Python-Cryptor)
[The Decryptor File](#The-Decryptor-File)
[Compiling-the-Decryptor](#Compiling-the-Decryptor)
[Adding the Decryptor to A Host Program](#Adding-the-Decryptor-to-A-Host-Program)
[Compiling & Executing the Test Host Program](#Compiling-&-Executing-the-Test-Host-Program)
[](#)
